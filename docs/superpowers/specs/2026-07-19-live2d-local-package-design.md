...
2. 当前公开模型来源为 `Open-LLM-VTuber/live2d-models/mao_pro/`，部署到 `scenic-guide/static/live2d-models/mao_pro/`；不覆盖未参与本地演示的其他模型。
...
- 浏览器确认 Core 脚本加载完成、Live2D Host 创建模型 Canvas、页面不显示 SDK 降级提示，并显示真实 Live2D 模型。
